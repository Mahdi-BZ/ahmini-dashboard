...
const FemmeNonPayee3Mois: React.FC<Props> = ({className}) => {
    const randomData = [
  ...
  return (
    <div className={`card ${className}`}>
      {/* begin::Header */}
      <SimpleTableCardHeader name={'Femmes Non Payée par 3 Mois'} isFemale={true} />
      {/* end::Header */}
...
export default FemmeNonPayee3Mois
