...
const FemmeNonPayeeMois: React.FC<Props> = ({className}) => {
    const randomData = [
  ...
  return (
    <div className={`card ${className}`}>
      {/* begin::Header */}
      <SimpleTableCardHeader name={'Femmes Non Payée plus d\'un Mois'} isFemale={true} />
      {/* end::Header */}
...
export default FemmeNonPayeeMois
