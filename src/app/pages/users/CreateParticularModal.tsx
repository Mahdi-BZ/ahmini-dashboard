...
import { defaultCreateAppData, ICreateAppData } from '../dashboard/_modals/create-app-stepper/IAppModels'
...
const CreateParticularModal: React.FC<Props> = ({show, handleClose}) => {
