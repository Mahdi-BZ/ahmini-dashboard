  ...
  return (
    <>
      ...
      >
        ...
        <AsideMenuItem to='/crafted/declaredsinister' title='Liste des sinistres déclarés' hasBullet={true} />
        <AsideMenuItem to='/crafted/paidsinister' title='Liste des sinistres payés' hasBullet={true} />
      </AsideMenuItemWithSub>
